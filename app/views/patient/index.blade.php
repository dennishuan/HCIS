...
<div>
  {{ link_to_route('upPat', 'UPLOADPATIENTS', null, ['class' => 'btn btn-default']) }}
  {{ link_to_route('exportPat', 'EXPORTPATIENTS', null, ['class' => 'btn btn-default']) }}
</div>
  ...
  <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-refresh="true" data-show-columns="true" data-toolbar="#toolbar" data-click-to-select="true">
    <thead>
      <tr>
        ...
        <th data-field="phn" data-sortable="true">Personal Health Number</th>
